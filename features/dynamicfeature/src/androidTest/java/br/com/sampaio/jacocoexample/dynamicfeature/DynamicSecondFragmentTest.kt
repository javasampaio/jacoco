...
class DynamicSecondFragmentTest {
    ...
    fun onViewFragment() {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.dynamic_button_second)).check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    }

    private fun startFragment() {
        activityScenario = ActivityScenario.launch(SingleFragmentActivity::class.java)

        val fragment = DynamicSecondFragment()
